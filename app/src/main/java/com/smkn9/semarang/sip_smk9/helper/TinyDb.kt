...
class TinyDb(appContext: Context?) {
    ...
    fun putListObject(key: String, objArray: List<SoalEssayItem>) {
        val gson = Gson();
...
//    fun getListObject(key: String,mClass : Class<SoalEssayItem> ) : List<SoalEssayItem>{
//        val gson = Gson();
//        val objStrings = getListString(key)
//        val objects = mutableListOf<SoalEssayItem>()
//
//        for (i in objStrings){
//            val value = gson.fromJson<Any>(objStrings,mClass)
//        }
//    }
//    public ArrayList<Object> getListObject(String key, Class<?> mClass){
//
