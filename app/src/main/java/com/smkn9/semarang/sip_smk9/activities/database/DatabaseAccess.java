package com.smkn9.semarang.sip_smk9.activities.database;
...
public class DatabaseAccess {
    ...
    //insert Hutang
    public boolean addHutang(
            String nama_debitur,
            String besaran_hutang,
            String keterangan_hutang,
            String tanggal_hutang,
            String status_hutang,
            String hutang_id) {

        ContentValues values = new ContentValues();


        values.put("nama_debitur", nama_debitur);
        values.put("besaran_hutang", besaran_hutang);
        values.put("keterangan_hutang", keterangan_hutang);
        values.put("tanggal_hutang", tanggal_hutang);
        values.put("status_hutang", status_hutang);
        values.put("hutang_id", hutang_id);


        long check = database.insert("hutang_details", null, values);
        database.close();
    ...
    //edit hutang
    public boolean editHutang(
            String namaDebitur,
            String besaranHutang,
            String keteranganHutang,
            String tanggalHutang,
            String statusHutang,
            String hutangId) {
        ...
        values.put("nama_debitur", namaDebitur);
        values.put("besaran_hutang", besaranHutang);
        values.put("keterangan_hutang", keteranganHutang);
        values.put("tanggal_hutang", tanggalHutang);
        values.put("status_hutang", statusHutang);
        values.put("hutang_id", hutangId);


        long check = database.update("hutang_details", values, "hutang_id=?", new String[]{hutangId});
        database.close();
    ...
    //insert products
    public boolean addProduct(String product_name, String product_code, String product_category, String product_description, String product_buy_price, String product_sell_price, int product_stock, String product_supplier, String product_image, String weight_unit_id, String product_weight) {
    ...
    //insert products
    public boolean updateProduct(String product_name, String product_code, String product_category, String product_description, String product_buy_price, String product_sell_price, int product_stock, String product_supplier, String product_image, String weight_unit_id, String product_weight, String product_id) {
    ...
    //get buy product price
    public String gethargaBeli(String product_id) {
    ...
    public int addToCart(String product_id, String weight, String weight_unit, String price, int qty,int stock) {
    ...
    public void insertOrder(String order_id, JSONObject obj,String paymentMethod) {
        ...
        try {
            ...
            //ini kayaknya penyebabnya, tadinya pending saya rubah jadi

            if (order_payment_method.equals("TEMPO")) {
                values.put(Constant.ORDER_STATUS, Constant.PENDING);
            } else {
                values.put(Constant.ORDER_STATUS, Constant.COMPLETED);
            }
//            values.put(Constant.ORDER_STATUS, Constant.COMPLETED);
            ...
            //coba kita buat delete order di product cart terhapus ketika print sukses
        ...
        try {
            ...
            for (int i = 0; i < result.length(); i++) {
                ...
                String product_buy_price = jo.getString("product_buy_price");
                ...
                if (paymentMethod.equals("TEMPO")) {
                    values2.put(Constant.ORDER_STATUS, Constant.PENDING);
                } else {
                    values2.put(Constant.ORDER_STATUS, Constant.COMPLETED);
                }
//                values2.put(Constant.ORDER_STATUS, Constant.PENDING);

                values2.put("product_buy_price",product_buy_price);
    ...
    //insert hutang
    //insert order in order list
//    public void insertHutang(JSONObject obj) {
//
//        ContentValues values = new ContentValues();
//
//        try {
//            String nama_debitur = obj.getString("nama_debitur");
//            String besaran_hutang = obj.getString("besaran_hutang");
//            String keterangan_hutang = obj.getString("keterangan_hutang");
//            String tanggal_hutang = obj.getString("");
//            String status_hutang = obj.getString("customer_name");
//
//
//
//            values.put("nama_debitur", nama_debitur);
...
//
//
//            database.insert("hutang_details", null, values);
//
////            database.delete("product_cart", null, null);
//
//
...
//    }
    ...
    //ini untuk mendapatkan list hutang yang belum terbayar
    @SuppressLint("Range")
    public ArrayList<HashMap<String, String>> getListHutang() {
        ArrayList<HashMap<String, String>> listHutang = new ArrayList<>();
        Cursor cursor = database.rawQuery("SELECT * FROM hutang_details WHERE status_hutang='"+Constant.UNPAID+"'ORDER BY hutang_details_id DESC", null);
        if (cursor.moveToFirst()) {
            do {
                HashMap<String, String> map = new HashMap<String, String>();


                map.put("nama_debitur", cursor.getString(1));
                map.put("besaran_hutang", cursor.getString(2));
                map.put("keterangan_hutang", cursor.getString(3));
                map.put("tanggal_hutang", cursor.getString(4));
                map.put("status_hutang", cursor.getString(5));
                map.put("hutang_id", cursor.getString(6));
    ...
    @SuppressLint("Range")
    public ArrayList<HashMap<String, String>> getOrderListPiutang() {
        ArrayList<HashMap<String, String>> orderList = new ArrayList<>();
        Cursor cursor = database.rawQuery("SELECT * FROM order_list WHERE order_status='"+Constant.PENDING+ "' ORDER BY order_id DESC", null);
        if (cursor.moveToFirst()) {
            do {
                HashMap<String, String> map = new HashMap<String, String>();
    ...
    @SuppressLint("Range")
    public ArrayList<HashMap<String, String>> searchListHutang(String s) {
        ArrayList<HashMap<String, String>> listHutang = new ArrayList<>();
        Cursor cursor = database.rawQuery("SELECT * FROM hutang_details WHERE nama_debitur LIKE '%" + s + "%' ORDER BY hutang_details_id DESC", null);
        if (cursor.moveToFirst()) {
            do {
                HashMap<String, String> map = new HashMap<String, String>();
    ...
    public ArrayList<HashMap<String, String>> getSalesReport(String type) {
        ...
        if (type.equals("all")) {
            ...
            cursor = database.rawQuery("SELECT * FROM order_details  WHERE order_status='"+Constant.COMPLETED+"' AND product_order_date='" + type + "' ORDER BY order_Details_id DESC", null);
        }
    ...
    //get buy price product
    public String getProductBuy(String product_id) {

        String productBuyPrice = "n/a";
        Cursor cursor = database.rawQuery("SELECT * FROM products WHERE product_id='" + product_id + "'", null);
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                productBuyPrice = cursor.getString(5);
    ...
    public double getTotalDiscount(String type) {
        ...
        if (type.equals("monthly")) {
            ...
            cursor = database.rawQuery("SELECT * FROM order_list WHERE order_status='"+Constant.COMPLETED+"'  AND   order_date='" + type + "' ORDER BY order_id DESC", null);
        }
    ...
    public double getTotalOrderPrice(String type) {
        ...
        if (type.equals("monthly")) {
            ...
            Log.d("price", "getTotalOrderPrice: "+ type);
            cursor = database.rawQuery("SELECT * FROM order_details WHERE order_status='"+Constant.COMPLETED+"'  AND   product_order_date='" + type + "' ORDER BY order_Details_id DESC", null);
    ...
    //mendapatkan total harga dasar
    public double getTotalModal(String type) {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                double price = Double.parseDouble(cursor.getString(9));
                int qty = Integer.parseInt(cursor.getString(4));
                double sub_total = price * qty;
                total_price = total_price + sub_total;
    ...
    public double getTotalOrderPiutang(String type) {
        ...
        if (type.equals("monthly")) {
            ...
            String sql = "SELECT * FROM order_details WHERE order_status='"+Constant.PENDING+"'  AND strftime('%m', product_order_date) = '" + currentMonth + "' ";
            ...
            String currentYear = new SimpleDateFormat("yyyy", Locale.ENGLISH).format(new Date());
            String sql = "SELECT * FROM order_details WHERE order_status='"+Constant.PENDING+"'  AND  strftime('%Y', product_order_date) = '" + currentYear + "' ";
            ...
            cursor = database.rawQuery("SELECT * FROM order_details WHERE order_status='"+Constant.PENDING+"'  AND   product_order_date='" + currentDate + "' ORDER BY order_Details_id DESC", null);
            ...
            cursor = database.rawQuery("SELECT * FROM order_details WHERE order_status='"+Constant.PENDING+"' ", null);
    ...
    public double getTotalHutang(String type) {
        ...
        if (type.equals("monthly")) {
            ...
            String sql = "SELECT * FROM hutang_details WHERE status_hutang='"+Constant.UNPAID+"'  AND strftime('%m', tanggal_hutang) = '" + currentMonth + "' ";
            ...
            String currentYear = new SimpleDateFormat("yyyy", Locale.ENGLISH).format(new Date());
            String sql = "SELECT * FROM hutang_details WHERE status_hutang='"+Constant.UNPAID+"'  AND  strftime('%Y', tanggal_hutang) = '" + currentYear + "' ";
            ...
            cursor = database.rawQuery("SELECT * FROM hutang_details WHERE status_hutang='"+Constant.COMPLETED+"'  AND   tanggal_hutang='" + currentDate + "' ORDER BY order_details_id DESC", null);
            ...
            cursor = database.rawQuery("SELECT * FROM hutang_details WHERE status_hutang='"+Constant.UNPAID+"' ", null);
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                double hutang = Double.parseDouble(cursor.getString(2));
//                int qty = Integer.parseInt(cursor.getString(4));
//                double sub_total = price * qty;
...
//
//        else {
            cursor = database.rawQuery("SELECT * FROM products WHERE product_stock!='"+"0"+"' ", null);
...
//        }
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                double hargaDasar = Double.parseDouble(cursor.getString(5));
                int qty = Integer.parseInt(cursor.getString(9));
                double aset = hargaDasar * qty;
                totalAset = totalAset + aset;
    ...
    public double getTotalExpense(String type) {
        ...
        if (type.equals("monthly")) {
            ...
            cursor = database.rawQuery("SELECT * FROM expense WHERE   expense_date='" + type + "' ORDER BY expense_id DESC", null);
        }
...
//        Cursor cursor = database.rawQuery("SELECT * FROM products ORDER BY product_id DESC", null);
        Cursor cursor = database.rawQuery("SELECT * FROM products ORDER BY product_stock ASC", null);
        if (cursor.moveToFirst()) {
            do {
                HashMap<String, String> map = new HashMap<String, String>();
    ...
    //delete hutang
    public boolean updateHutang(String hutangId,String statusHutang) {


        ContentValues contentValues=new ContentValues();
        contentValues.put(Constant.STATUS_HUTANG,statusHutang);

        long check = database.update(Constant.hutangDetails, contentValues,"hutang_id=?", new String[]{hutangId});
        database.update(Constant.orderDetails, contentValues,"hutang_id=?", new String[]{hutangId});
    ...
    public boolean updateOrder(String invoiceId,String orderStatus) {
        ...
        contentValues2.put(Constant.ORDER_STATUS,orderStatus);
        contentValues2.put("product_order_date",currentDate);


        long check = database.update(Constant.orderList, contentValues,"invoice_id=?", new String[]{invoiceId});
        database.update(Constant.orderDetails, contentValues2,"invoice_id=?", new String[]{invoiceId});
    ...
    public boolean updateInvoice(String invoiceId) {
...
//        String currentDate = new SimpleDateFormat("yyyy-MM-dd", Locale.ENGLISH).format(new Date());
        ContentValues contentValues2 =new ContentValues();
        contentValues2.put(Constant.INVOICE_STATUS,"sudah");
//        contentValues2.put("product_order_date",currentDate);


//        long check = database.update(Constant.orderList, contentValues,"invoice_id=?", new String[]{invoiceId});
        long check = database.update(Constant.orderDetails, contentValues2,"invoice_id=?", new String[]{invoiceId});
    ...
    public boolean getStatusPrint(String invoiceId) {
        ArrayList<HashMap<String, String>> orderDetailsList = new ArrayList<>();
        Cursor cursor = null;

            cursor = database.rawQuery("SELECT * FROM order_details  WHERE invoice_id='"+invoiceId+"' AND invoice_printed='" +"sudah", null);
...
//        return orderDetailsList;
    ...
    //delete cart order
    public boolean deleteCartOrder(String invoice_id) {


        long check = database.delete("product_cart", "invoice_id=?", new String[]{invoice_id});
        database.close();
    ...
    //memasukan string wajah yang dikenali
    public boolean updateWajah(String invoiceId) {
...
//        long check = database.update(Constant.orderList, contentValues,"invoice_id=?", new String[]{invoiceId});
    ...
    //get product name
    public String getNamaPegawai(String nip) {

        String nama = "n/a";
        Cursor cursor = database.rawQuery("SELECT * FROM pegawai WHERE nip='" + nip + "'", null);
